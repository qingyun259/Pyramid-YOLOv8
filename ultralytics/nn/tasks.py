...
from ultralytics.nn.Pyramid import C2f_Pyramid, Pyramid_Bottleneck
try:
    import thop
except ImportError:
    thop = None
...
def parse_model(d, ch, verbose=True, warehouse_manager=None):  # model_dict, input_channels(3)
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):  # from, number, module, args
        ...
        if m in (Classify, Conv, ConvTranspose, GhostConv, Bottleneck, GhostBottleneck, SPP, SPPF, DWConv, Focus,
            ...
            if m in (BottleneckCSP, C1, C2, C2f, C3, C3TR, C3Ghost, C3x, RepC3, C2f_Faster, C2f_Pyramid):
        ...
        elif m in {SpatialAttention, Partial_conv3}:
            c2 = ch[f]
            args = [c2, *args]
            # print(args)
        elif m is CBAM:
