...
class Annotator:
    ...
    def box_label(self, box, total_area=0, label='', color=(128, 128, 128), txt_color=(255, 255, 255), ):
        ...
        if self.pil or not is_ascii(label):
            ...
            #     color = (0, 255, 0)  # 浅绿
            #     disease_class = 1
            # elif 0.506151 <= ratio < 0.948323:
            #     color = (0, 128, 0)  # 绿色
            #     disease_class = 2
            # elif 0.948323 <= ratio < 1.56639:
            #     color = (0, 255, 255)  # 黄
            #     disease_class = 3
            # elif 1.56639 <= ratio < 2.556879:
            #     color = (0, 89, 255)  # 橙色
            #     disease_class = 4
            # else:
            #     color = (0, 0, 255)  # 红
            #     disease_class = 5
            # text = f"Level {disease_class} disease"
            # font_scale = 6 # 字体缩放比例
            ...
            # # 计算文本框的左下角坐标（矩形的左下角）
            # text_offset_x = 10
            # text_offset_y = text_height + padding * 2
            #
            # # 绘制文本框背景
            # cv2.rectangle(self.im, (text_offset_x, text_offset_y - text_height - padding),
            #               (text_offset_x + text_width + padding, text_offset_y + baseline + padding),
            #               (0, 0, 0), cv2.FILLED)
            #
            # # 放置文本
            # cv2.putText(self.im, text, (text_offset_x + padding, text_offset_y),
            #             cv2.FONT_HERSHEY_SIMPLEX, font_scale, (255, 255, 255), font_thickness)
            # overlay = self.im.copy()
            #
            # # 绘制椭圆
            # cv2.ellipse(overlay, center, axes, 0, 0, 360, color, -1)  # 使用-1填充椭圆
            #
            # # 透明度融合
            # alpha = .65  # 透明度
