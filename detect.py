...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='images', help='source directory for images or videos')
    ...
    parser.add_argument('--name', type=str, default='predict', help='experiment name (project/name)')
