...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='G:/2023_dandong/blast/2023.07.29_dandong', help='source directory for images or videos')
    parser.add_argument('--conf', type=float, default=0.45, help='object confidence threshold for detection')
    parser.add_argument('--iou', type=float, default=0.45, help='intersection over union (IoU) threshold for NMS')
    parser.add_argument('--mode', type=str, default='predict', choices=['predict', 'track'], help='predict mode or track mode')
    parser.add_argument('--project', type=str, default='G:/2023_dandong/blast', help='project name')
    parser.add_argument('--name', type=str, default='YOLOv8_conf', help='experiment name (project/name)')
    ...
    parser.add_argument('--line_width', type=int, default=9, help='line width of the bounding boxes')
